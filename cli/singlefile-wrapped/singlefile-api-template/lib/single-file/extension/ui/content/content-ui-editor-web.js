...
.reader-show-element {
  display: initial;
	...
	async function init(content, { filename, reset } = {}) {
		...
		content = content.replace(/<script data-template-shadow-root.*<\/script>/g, "<script data-template-shadow-root src=/lib/single-file/dist/web/editor/editor-init-web.js></script>");
